...
class DashboardCards {
            ...
            <div class="dashboard__item dashboard__item--${id}">
                <article class="tracking-card">
                    ...
                    <div class="tracking-card__body">
                        ...
                        Last ${DashboardCards.PERIODS[this.view]} ${previous}hrs
                        </div>
                    </div>
                </article>
            </div>
    ...
    changeView(view) {
        ...
        this.prev.innerText = `Last ${DashboardCards.PERIODS[this.view]} ${previous}hrs`;
    }
}
...
document.addEventListener('DOMContentLoaded', () =>{
    getDashboardData()
    .then(data => {
        const activities = data.map(activity => new DashboardCards(activity));
